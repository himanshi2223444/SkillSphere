...
const FrameComponent1 = () => {
  ...
  return (
    <div className="w-[37.875rem] flex flex-col items-start justify-start gap-[5.063rem_0rem] max-w-full text-left text-[1.563rem] text-gray font-quicksand mq450:gap-[1.25rem_0rem] mq675:gap-[2.5rem_0rem]">

    ...
    <>
      <div className="bg-white-A700 flex font-quicksand h-[2712px] justify-end mx-auto relative w-full">
        ...
        <div className="absolute bg-blue_gray-900_93 bottom-[0] flex flex-col font-ramaraja inset-x-[0] items-center justify-start mx-auto pb-[291px] md:px-10 sm:px-5 px-[291px] w-full">
          <div className="bg-white-A700 flex flex-col items-center justify-start mb-[1882px] p-5 md:px-5 rounded-lg w-[97%] md:w-full">
            <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between my-3.5 w-[99%] md:w-full">
              <div className="flex flex-col gap-[13px] items-center justify-start w-[53%] sm:w-full">
                <List
                  className="flex flex-col gap-3 items-center w-full"
                  orientation="vertical"
                >
                  <div className="flex flex-1 sm:flex-col flex-row gap-[22px] items-center justify-between my-0 w-full">
                    <div className="font-ramaraja h-[59px] relative w-[11%] sm:w-full">
                    ...
                    <Button className="bg-transparent cursor-pointer font-bold font-quicksand leading-[normal] text-[22px] text-center text-gray-900 sm:text-lg md:text-xl">
                      <>
                        Denis Kravets
                        <br />
                ...
                <List
                  ...
                  orientation="vertical"
                >
                  <div className="flex flex-1 sm:flex-col flex-row gap-[22px] items-center justify-between w-full">
              ...
              <div className="flex flex-col font-quicksand gap-[49px] items-center justify-start sm:mt-0 mt-[27px]">
                <Text
...
export default SearchButtonTwoPage;

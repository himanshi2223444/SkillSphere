        ...
        <div className="md:h-[2590px] h-[2750px] sm:h-[4673px] m-auto md:px-5 w-full">
          <div className="flex md:h-[2590px] h-[2750px] sm:h-[4673px] justify-end m-auto w-full">
            ...
            <Img
              ...
              src="images/img_rectangle61_2590x1440.png"
          ...
          >
            <div className="flex flex-col items-start justify-start mb-[5px] mt-[15px] w-full">
              ...
              <div className="flex md:flex-col flex-row font-quicksand md:gap-5 items-start justify-start mt-[15px] w-full">
                ...
                <div className="bg-light_green-800 flex flex-col h-[29px] items-center justify-start mb-3.5 md:ml-[0] ml-[291px] md:mt-0 mt-[93px] rounded-[14px] w-[29px]">
                  <div className="h-[29px] relative w-[29px]">
                    <Img
                      className="h-[29px] m-auto object-cover w-[29px]"
                      src="images/img_imageremovebgpreview.png"
                      alt="imageremovebgpr"
                    />
                    <Img
                      className="absolute h-[29px] inset-[0] justify-center m-auto object-cover w-[29px]"
                      src="images/img_imageremovebgpreview.png"
                      alt="maskgroup_Three"
                    />
                  </div>
                ...
                <Button
                  className="border border-gray-900 border-solid flex h-[29px] items-center justify-center mb-3.5 ml-3.5 md:ml-[0] md:mt-0 mt-[93px] rounded-[14px] w-[29px]"
                  color="white_A700"
                  size="xs"
                  variant="fill"
                >

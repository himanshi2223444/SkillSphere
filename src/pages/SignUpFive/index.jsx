...
const SignUpFivePage = () => {
  const navigate = useNavigate();
  const [userID, setUserID] = useState("");
  const location = useLocation();
 
  const { username = "", email = "" } = location.state || {}; // Get the username from location state
        ...
        <div className="flex flex-col gap-[53px] h-full justify-start ml-[7px] md:px-5 w-[88%]">
          <div className="flex flex-row sm:gap-10 gap-[339px] items-start justify-start w-[44%] md:w-full">
            ...
            <Button
              ...
              onClick={() => navigate("/signuptwo",{state:{username:username,email:email}})}
              leftIcon={
              ...
              <div className="flex md:flex-col flex-row md:gap-[47px] items-center justify-between w-[98%] md:w-full">
                <div className="flex flex-col justify-start">
                  ...
                  <Button
                    ...
                    onClick={() => navigate("/signupthree",{state:{username:username,email:email}})}
                    color="gray_900"
                    size="md"
                    variant="fill"
                  >
